...
class Neo_Gallery_Adminhtml_CategoryController extends Mage_Adminhtml_Controller_Action
{
		protected function _initAction()
		{
				$this->loadLayout()->_setActiveMenu("gallery/category")->_addBreadcrumb(Mage::helper("adminhtml")->__("Category  Manager"),Mage::helper("adminhtml")->__("Category Manager"));
				return $this;
		}
		...
		{			    
				...
				if ($model->getId()) {
					...
					$this->loadLayout();
					$this->_setActiveMenu("gallery/category");
					...
					$this->_addContent($this->getLayout()->createBlock("gallery/adminhtml_category_edit"))->_addLeft($this->getLayout()->createBlock("gallery/adminhtml_category_edit_tabs"));
					$this->renderLayout();
				} 
				else {
		...
		public function exportCsvAction()
		{
			...
			$grid       = $this->getLayout()->createBlock('gallery/adminhtml_category_grid');
